...
: base(ItemType.Essence, "신속의 정수",
    ...
    public override void OnActiveUse()
    {
        ...
        {
            movePos = new Vector2(Player.Instance.transform.position.x + Player.Instance.Stat.Get(StatType.DashLength) * stare * Player.Instance.Stat.Get(StatType.EssenceForce), Player.Instance.transform.position.y);
        }
